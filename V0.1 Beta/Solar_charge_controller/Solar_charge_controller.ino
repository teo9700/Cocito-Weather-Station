/*
 * Original version made from deba168
...
//-------------------------------------------------------------------------------------------------------------
 void read_data(void) 
 {
    ...
    //panel R1=81k R2=14.81k   Batt R1=81k R2=15k
     solar_volt = read_adc(SOL_ADC)*0.00557*(95.81/14.81);  //tweak these numbers to get the perfect value (check with a multimeter)
     bat_volt   = read_adc(BAT_ADC)*0.00552*(96/15);    
